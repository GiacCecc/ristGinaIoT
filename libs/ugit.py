...
from utils.secrets import GITHUB_USER, GITHUB_REPO, GITHUB_TOKEN
...
#ssid = "Vodafone-F344"
#password = "AhRdJCQmqmGaT7tN"

#user = 'GiacCecc'
#repository = 'ristGinaIoT'
#token = ''

# Put the files you don't want deleted, don't remove ugit.py from the ignore_files 
ignore_files = [
    '/libs/ugit.py',   # libs.1
    '/libs/umongo.py', # libs.2
    '/libs/uutil.py',  # libs.3
    '/libs/uwhat.py',  # libs.4
    '/libs/uwifi.py',  # libs.5
    '/utils/secrets.py',  # utils.1
    '/utils/settings.py', # utils.2
    # '/main.py',
    '/boot.py'
    ]
ignore = ignore_files
...
# Static URLS - GitHub uses 'main' instead of master for python repository trees
giturl = 'https://github.com/{user}/{repository}'
call_trees_url = f'https://api.github.com/repos/{GITHUB_USER}/{GITHUB_REPO}/git/trees/main?recursive=1'
raw = f'https://raw.githubusercontent.com/{GITHUB_USER}/{GITHUB_REPO}/master/'
